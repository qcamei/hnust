...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="J_menuItem" href="/mooc/index.php/admin?target=index_v1">
                ...
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <div class="dropdown pull-right" style="height: 100%;padding: 7px;">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="J_menuItem" href="/mooc/index.php/admin?target=updatepsw" alt="修改密码">修改密码</a></li>
                            <li><a href="/mooc/index.php/logout" alt="退出登录">退出登录</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="/mooc/index.php/admin?target=index_v1" frameborder="0" data-id="_adminTPL_/index_v1.html" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
    ...
    <script type="text/javascript" src="/mooc/Public/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script type="text/javascript" src="/mooc/Public/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>
