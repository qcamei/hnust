...
<body class="gray-bg">
    <div class="wrapper wrapper-content">
                    ...
                    <div class="ibox-content" id="eg">
                        <div class="row" style="border-bottom:1px solid rgb(40,137,221); margin-bottom:10px;">
                            ...
                            <div class="col-xs-10 col-xs-offset-1">
                                ...
                                <script type="text/javascript" src="/Public/js/utf8-php/ueditor.parse.js"></script>
                                <!-- 实例化编辑器 -->
                            </div>
                        </div>
                    </div>
        ...
        <script type="text/javascript" src="/Public/js/content.js?v=1.0.0"></script>
        <script type="text/javascript" src="/Public/js/plugins/iCheck/icheck.min.js"></script>
        <script type="text/javascript" src="/Public/js/plugins/layer/laydate/laydate.js"></script>
        <script type="text/javascript" src="/Public/js/own/editorNews.js"></script>
        <script type="text/javascript">
